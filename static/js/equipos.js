...
function filterTeams() {
    ...
    let filteredTeams = allTeams.filter(team => {
        ...
        if (statusFilter === 'ACTIVO') {
            matchesStatus = team.estado && 
                (team.estado.toUpperCase() === 'ACTIVO' || team.estado.toUpperCase() === 'ACTIVOS');
        } else if (statusFilter === 'INACTIVO') {
            matchesStatus = team.estado && 
                (team.estado.toUpperCase() === 'INACTIVO' || team.estado.toUpperCase() === 'INACTIVOS');
        }
...
teamsContainer.innerHTML = '';
teams.forEach(team => {
        // Usa el id_equipo para construir el nombre del logo
    const logo = `/static/imagenes/logos/${team.id_equipo}.png`;
    const teamCard = document.createElement('div');
    teamCard.className = 'col-md-4 mb-4';
    teamCard.innerHTML = `
        <div class="card team-card">
            <div class="card-body text-center">
                <img src="${logo}" alt="Logo del equipo" class="team-logo"
                     onerror="this.onerror=null;this.src='/static/imagenes/logos/default.png';">
